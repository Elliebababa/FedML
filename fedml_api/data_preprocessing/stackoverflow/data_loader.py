...
def get_dataloader(dataset, data_dir, train_bs, test_bs, client_idx = None):
    ...
    train_id = list(train_h5[_EXAMPLE].keys())
    test_id = list(test_h5[_EXAMPLE].keys())
    ...
    train_ds = []
    test_ds = []
    for client_id in tqdm.tqdm(client_ids_train):
    ...
    for client_id in tqdm.tqdm(client_ids_test):
